    ...
    <div className="fixed inset-0 z-10 pointer-events-none">
      <ResponsiveContainer width="100%" height="100%">
        ...
        <CartesianGrid strokeDasharray="4 4" stroke="#e5e7eb" />
          {/* 軸は非表示（アンビエントデザイン） */}
          <XAxis dataKey="time" ticks={timeLabel} niceTicks="snap125" />
          {/* <YAxis domain={[0, 'auto']} hide /> */}
          <YAxis domain={[dataMin => Math.floor(dataMin * 0.9), dataMax => Math.floor(dataMax * 1.1)]} niceTicks="snap125" hide/> // 最小値の10%下を基点
          ...
          <Area
            ...
            isAnimationActive={false}   // 再レンダリング時のアニメーションをOFF
          ...
          >
            <LabelList 
                ...
                content={(props) => {
                    ...
                    // 4時間ごとにラベルを表示（データは30分ごとなので、8時間ごとに表示する場合は index % 16 === 0）
